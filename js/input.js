...
function bindTouch() {
  ...
  if (fullscreen) fullscreen.addEventListener("click", function () {
    ...
    if (!document.fullscreenElement) {
      if (!target.requestFullscreen) { Game.showMessage("FULLSCREEN IS NOT SUPPORTED BY THIS BROWSER"); return; }
      target.requestFullscreen().catch(function () { Game.showMessage("FULLSCREEN REQUEST BLOCKED"); });
